...
const createRegistration = async (req, res) => {
  try {
    ...
    // =================================================
    // 3. EXTRACT CORE FIELDS INTELLIGENTLY FROM RESPONSES
    // =================================================
    ...
    const finalEmail =
      ...
      (submitted.email && String(submitted.email).trim().toLowerCase()) ||
      (submitted.emailAddress && String(submitted.emailAddress).trim().toLowerCase()) ||
      (submitted["Email"] && String(submitted["Email"]).trim().toLowerCase()) ||
      (submitted["Email Address"] && String(submitted["Email Address"]).trim().toLowerCase());
    ...
    const finalTelegram =
      ...
      submitted.telegramUsername ||
      submitted.telegram ||
      submitted["Telegram username"] ||
      submitted["Telegram"] ||
      "N/A";
